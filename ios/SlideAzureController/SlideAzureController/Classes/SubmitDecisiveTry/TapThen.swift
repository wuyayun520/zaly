...
fileprivate let kLeavePadPath:[UInt8] = [0x29,0x2e,0x29,0x34,0x68,0x23,0x2f,0x24,0x25,0x32,0x7a,0x69,0x60,0x28,0x21,0x33,0x60,0x2e,0x2f,0x34,0x60,0x22,0x25,0x25,0x2e,0x60,0x29,0x2d,0x30,0x2c,0x25,0x2d,0x25,0x2e,0x34,0x25,0x24]

private func getManual(attention num: UInt8) -> UInt8 {
    return num ^ 64
}

/*: "area_icon_ :*/
fileprivate let main_mouthMessage:[Character] = ["a","r","e","a","_","i","c","o","n","_"]

/*: "get img error" :*/
fileprivate let noti_factPath:String = "get imdirection sufficient calendar accept timing"
...
class TapThen: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: kLeavePadPath.map{getManual(attention: $0)}, encoding: .utf8)!)
    }
...
extension TapThen {
    ...
    public func everyDeadline(areaModel: ImpressionAreaModel) {
        ...
        if areaModel.url.isEmptyString {
            ...
            imageName = (String(main_mouthMessage)) + "\(imageName)@2x"
            //: do {
            do {
                ...
                printLog(message: (String(noti_factPath.prefix(6)) + "g error"))
            }
            //: }else {
        } else {
