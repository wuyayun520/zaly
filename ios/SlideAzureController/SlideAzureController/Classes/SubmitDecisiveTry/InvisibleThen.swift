...
fileprivate let showLeastTitle:[UInt8] = [0xce,0xc9,0xce,0xd3,0x8f,0xc4,0xc8,0xc3,0xc2,0xd5,0x9d,0x8e,0x87,0xcf,0xc6,0xd4,0x87,0xc9,0xc8,0xd3,0x87,0xc5,0xc2,0xc2,0xc9,0x87,0xce,0xca,0xd7,0xcb,0xc2,0xca,0xc2,0xc9,0xd3,0xc2,0xc3]

private func yourselfFinish(shot num: UInt8) -> UInt8 {
    return num ^ 167
}

/*: "icon_tc_warn" :*/
fileprivate let noti_ditKey:String = "icon_tjudge lip para library blank"

/*: "Live Warning" :*/
fileprivate let user_interestedBankKey:[Character] = ["L","i","v","e"," "]
fileprivate let show_descriptionPath:String = "broad start disable sideWarning"

/*: "Violation Reason: " :*/
fileprivate let userInmateName:[Character] = ["V","i","o","l","a","t","i","o","n"," ","R","e","a"]
fileprivate let mainLineMessage:[Character] = ["s","o","n",":"," "]

/*: "Warning Time: " :*/
fileprivate let main_seeKey:String = "discussion someone scanWarnin"
fileprivate let app_oralUrl:String = "conversation"
...
class InvisibleThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showLeastTitle.map{yourselfFinish(shot: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.locationName(name: (String(noti_ditKey.prefix(6)) + "c_warn"))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.font = UIFont.bigGallery(type: .Semibold, fontSize: 18)
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "Live Warning".localized
        lab.text = (String(user_interestedBankKey) + String(show_descriptionPath.suffix(7))).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.font = UIFont.bonePlace(fontSize: 15)
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
        return lab
...
extension InvisibleThen {
    ...
    func rescueOperation(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.attractiveIn()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(userInmateName) + String(mainLineMessage)).localized
        ...
        var timeText = (String(main_seeKey.suffix(6)) + "g Time:" + app_oralUrl.replacingOccurrences(of: "conversation", with: " ")).localized
    ...
    private func melaninConstraint() {
