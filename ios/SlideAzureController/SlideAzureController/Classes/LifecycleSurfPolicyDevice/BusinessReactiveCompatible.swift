...
fileprivate let constCareValue:[Character] = ["N","e","e","d"," ","a"," ","g","i","f","t"," ","t","o"," ","u","n","l","o","c","k"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let dataLabelKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "intimatephoto_btn_no" :*/
fileprivate let appPartnerFormat:[Character] = ["i","n","t","i","m","a","t","e","p","h","o"]
fileprivate let show_pointFormat:[Character] = ["t","o","_","b","t","n","_","n","o"]

/*: "Burn After Reading" :*/
fileprivate let mainSpaceData:[Character] = ["B","u","r"]
fileprivate let appBusinessSortKey:String = "n Aftgold register outlet cloud"
fileprivate let userMateUpMsg:String = "adparag"

/*: "Use Photo" :*/
fileprivate let user_womanFinishName:String = "Use Photsafety charm status night sample"
fileprivate let noti_applyKey:[Character] = ["o"]

/*: "Use Video" :*/
fileprivate let constDeepPath:String = "detect point thereUse Vi"
fileprivate let main_imageValue:[Character] = ["d","e","o"]

/*: "intimatephoto_btn_chose" :*/
fileprivate let k_stillStr:String = "indestroyi"
fileprivate let main_halfMinimumData:String = "king managero_bt"

/*: "%@ (%@x1  %@ Gold coins)" :*/
fileprivate let showSplitMessage:String = "%@ (%@"
fileprivate let dataPossibleMessage:String = "wrap discount able sceneGold c"

/*: "#7E6AFF" :*/
fileprivate let constFirmMsg:[Character] = ["#","7","E","6","A"]
fileprivate let constNightName:String = "bird"
...
// __CLOSE_PRINT__
//
//  BusinessReactiveCompatible.swift
//  AbroadTalking
//
...
class BusinessReactiveCompatible: UIView {
    ...
    init(frame: CGRect, type: AdjudicateViewType) {
        ...
        trendThroughSwaddlingClothes()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: dataLabelKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var burnAfterReadingImgV: UIImageView = {
        ...
        let img = UIImageView(image: UIImage.locationName(name: (String(appPartnerFormat) + String(show_pointFormat))))
    ...
    private lazy var burnAfterReadingLab: UILabel = {
        ...
        lab.text = (String(mainSpaceData) + String(appBusinessSortKey.prefix(5)) + "er Re" + userMateUpMsg.replacingOccurrences(of: "para", with: "in")).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var burnAfterReadingBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(coldShoulder), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var needGiftBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(clickPlus), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var useBtn: UIButton = {
        ...
        btn.setTitle(self.type == .intimatePhoto ? (String(user_womanFinishName.prefix(8)) + String(noti_applyKey)).localized : (String(constDeepPath.suffix(6)) + String(main_imageValue)).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(napClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var giftView: YaDataSource = {
...
extension BusinessReactiveCompatible {
    /// 使用照片按钮点击事件
    //: @objc private func useButtonClick() {
    @objc private func napClick() {
    ...
    @objc private func coldShoulder() {
        ...
        let imageName = burnAfterReadingBtn.isSelected ? (k_stillStr.replacingOccurrences(of: "destroy", with: "t") + "matephot" + String(main_halfMinimumData.suffix(4)) + "n_chose") : (String(appPartnerFormat) + String(show_pointFormat))
        //: burnAfterReadingImgV.image = UIImage.BundleImageNamed(name: imageName)
        burnAfterReadingImgV.image = UIImage.locationName(name: imageName)
    }
}
...
extension BusinessReactiveCompatible {
    ...
    @objc private func clickPlus() {
        ...
        guard needGiftBtn.isSelected == false else { // 还原状态
            ...
            needGiftImgeV.image = UIImage.locationName(name: (String(appPartnerFormat) + String(show_pointFormat)))
        ...
        let type = (self.type == .intimatePhoto ? DisableSubqueryConvertible.intimatePhoto : DisableSubqueryConvertible.intimateVideo)
        //: TalkingChatGiftManager.share.func__sendGiftEvent(type: type) {
        MotivationThen.share.tillTurn(type: type) {
    ...
    private func observerResume() {
        ...
        giftView.okActionBlock = { [weak self] giftModel in
            ...
            self.needGiftImgeV.image = UIImage.locationName(name: (k_stillStr.replacingOccurrences(of: "destroy", with: "t") + "matephot" + String(main_halfMinimumData.suffix(4)) + "n_chose"))
            ...
            let giftAttrStr = NSMutableAttributedString(string: (showSplitMessage.capitalized + "x1  %@ " + String(dataPossibleMessage.suffix(6)) + "oins)").unitedStates(self.normalGiftText, giftModel.name, giftModel.price))
            ...
            let attributes = [.foregroundColor: UIColor(hex: (String(constFirmMsg) + constNightName.replacingOccurrences(of: "bird", with: "FF")))!, .font: UIFont.bigGallery(type: .Regular, fontSize: 14)] as [NSAttributedString.Key: Any]
...
extension BusinessReactiveCompatible {
    ...
    private func minimise() {
        ...
        whiteBgV.addSubview(burnAfterReadingBtn)
        //: if DismissReactiveCompatible.share.loginUserMode.status != 1 &&
        if DismissReactiveCompatible.share.loginUserMode.status != 1,
    ...
    private func trendThroughSwaddlingClothes() {
        ...
        useBtn.snp.makeConstraints { make in
            ...
            make.bottom.equalToSuperview().offset(-20 - appInviteValue)
