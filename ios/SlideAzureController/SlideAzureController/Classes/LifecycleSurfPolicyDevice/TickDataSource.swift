...
fileprivate let app_norAuthorityTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_chats_banner_subtract" :*/
fileprivate let const_boneId:String = "icon_physical dynamics explore point"
fileprivate let dataExclusiveValue:String = "baappeale"
fileprivate let app_whetherName:String = "raourt"

/*: "icon_chats_banner_subtract_pre" :*/
fileprivate let data_grayEnableicialName:[Character] = ["i","c","o","n","_","c","h","a","t"]
fileprivate let dataSelectId:String = "register balance sun rushs_ba"
fileprivate let dataShoulderUrl:String = "nner_multi document category"
fileprivate let constDepthUrl:String = "ract_prebind table"

/*: "bannerList" :*/
fileprivate let noti_picId:String = "effectanner"
fileprivate let const_aboveValue:String = "read something observeList"

/*: "JXBannerCellID" :*/
fileprivate let const_adjustTitle:[Character] = ["J","X","B","a","n"]
fileprivate let main_towardPath:[Character] = ["n","e","r","C","e","l","l","I","D"]

/*: "#FFFFFF" :*/
fileprivate let data_coatId:[Character] = ["#","F","F","F","F","F","F"]
...
class TickDataSource: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_norAuthorityTitle.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var bannerListData: [PrimaryRedModelType] = //: return Array<PrimaryRedModelType>()
        .init()
    //: }()
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.setImage(UIImage.locationName(name: (String(const_boneId.prefix(5)) + "chats_" + dataExclusiveValue.replacingOccurrences(of: "appeal", with: "nn") + "r_subt" + app_whetherName.replacingOccurrences(of: "our", with: "c"))), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_chats_banner_subtract_pre"), for: .selected)
        btn.setImage(UIImage.locationName(name: (String(data_grayEnableicialName) + String(dataSelectId.suffix(4)) + String(dataShoulderUrl.prefix(5)) + "subt" + String(constDepthUrl.prefix(8)))), for: .selected)
...
extension TickDataSource {
    /// banner
    //: func reqBanner() {
    func however() {
        //: SocialRequestManager.init().req_adBanner(position: 3) { [weak self] succeed, result, errorModel in
        WallRangeRequestManager().genderStat(position: 3) { [weak self] _, result, _ in
            ...
            let array = JSON(result[(noti_picId.replacingOccurrences(of: "effect", with: "b") + String(const_aboveValue.suffix(4)))] ?? []).arrayValue
...
extension TickDataSource {
    ...
    @objc private func apply() {
        ...
        self.delegate?.birdSEyeView(isMiniView: isMiniView)
    }

    //: func resetView(isMiniView: Bool) {
    func sumoView(isMiniView: Bool) {
        //: if isMiniView {
        if isMiniView {
...
extension TickDataSource: JXBannerDelegate, JXBannerDataSource {
    ...
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        ...
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(const_adjustTitle) + String(main_towardPath)))
    }
    ...
    func jxBanner(_: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        ...
        tempCell.imageView.loadPoiseFinishParkImageEye(urlStr: url, placeImg: UIImage.regularPolygon())
                  ...
                  builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder
    {
        ...
        pageControl.activeColor = UIColor(hex: (String(data_coatId)))!
