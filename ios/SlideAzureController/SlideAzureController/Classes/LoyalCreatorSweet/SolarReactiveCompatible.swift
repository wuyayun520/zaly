...
fileprivate let userPitchData:[UInt8] = [0xf,0x14,0xf,0x1a,0xce,0x9,0x15,0xa,0xb,0x18,0xe0,0xcf,0xc6,0xe,0x7,0x19,0xc6,0x14,0x15,0x1a,0xc6,0x8,0xb,0xb,0x14,0xc6,0xf,0x13,0x16,0x12,0xb,0x13,0xb,0x14,0x1a,0xb,0xa]

fileprivate func readyTerms(robot num: UInt8) -> UInt8 {
...
class SolarReactiveCompatible: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.readingMakeRid()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.overdoLikeLable()
    ...
    var menuModel: MovementMenuModel? {
        //: didSet {
        didSet {
    ...
    var dropMenuStyle: BeautifulMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userPitchData.map{readyTerms(robot: $0)}, encoding: .utf8)!)
    }
    ...
    private func readingMakeRid() -> UIImageView {
    ...
    private func overdoLikeLable() -> UILabel {
    ...
    private func mutualLineupBy() {
        //: let lineLayer = CAShapeLayer()
        let lineLayer = CAShapeLayer()
        //: lineLayer.strokeColor = UIColor.RGBA(230, 230, 230, 1.0).cgColor
        lineLayer.strokeColor = UIColor.searched(230, 230, 230, 1.0).cgColor
