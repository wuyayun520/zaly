...
fileprivate let show_coldMessage:[UInt8] = [0x7a,0x7d,0x7a,0x67,0x3b,0x70,0x7c,0x77,0x76,0x61,0x29,0x3a,0x33,0x7b,0x72,0x60,0x33,0x7d,0x7c,0x67,0x33,0x71,0x76,0x76,0x7d,0x33,0x7a,0x7e,0x63,0x7f,0x76,0x7e,0x76,0x7d,0x67,0x76,0x77]

/*: "Enter phone number" :*/
fileprivate let app_questFormat:[Character] = ["E","n","t","e","r"," ","p","h","o","n","e"," ","n","u","m","b"]
fileprivate let k_speakData:String = "estyle"

/*: "Enter Email Address" :*/
fileprivate let const_masterData:[Character] = ["E","n","t","e","r"," ","E","m"]
fileprivate let appCurveName:String = "sense lat representative bulletail Ad"
fileprivate let noti_duringFreshUrl:String = "drecomposition"

/*: "F4F4F4" :*/
fileprivate let userRedMsg:String = "hiddenhiddenF"
fileprivate let userStoryUrl:String = "statistical"

/*: "America(+1)" :*/
fileprivate let constFairTitle:[Character] = ["A","m","e","r","i","c","a"]
fileprivate let show_denyData:String = "(+1)"

/*: "area_code_down_icon" :*/
fileprivate let mainEasternEffectiveText:String = "area_cogold speed"
fileprivate let app_harassmentStr:[Character] = ["d","e","_","d","o","w","n"]
fileprivate let notiThreadUrl:[Character] = ["_","i","c","o","n"]

/*: "BBBBBB" :*/
fileprivate let userSupplyValue:[Character] = ["B","B","B","B","B","B"]

/*: "btn_field_delete_icon" :*/
fileprivate let notiAssetEyebrowUrl:[Character] = ["b","t","n","_","f"]
fileprivate let const_originalStr:String = "ield_ddiscussion impulse later"
fileprivate let k_serveAlreadyPath:String = "cling mutual enable calendar margin_icon"

/*: "Password" :*/
fileprivate let appPhoneInfoFormat:[Character] = ["P","a","s","s","w","o","r","d"]

/*: "CCCCCC" :*/
fileprivate let mainLeadingMessage:[Character] = ["C","C","C","C","C","C"]

/*: "F5F5F5" :*/
fileprivate let user_engineeringFormat:String = "f5f5f5"

/*: "Next" :*/
fileprivate let data_smartValue:[Character] = ["N","e","x","t"]

/*: "Login by password" :*/
fileprivate let data_authorityName:String = "min please its automatically manLogi"
fileprivate let show_visualMessage:[Character] = ["a","s"]
fileprivate let userShowArtName:String = "sworshould"

/*: "Login by OTP" :*/
fileprivate let dataJumpPhysicsPath:String = "Login program estimated reject line fore"
fileprivate let dataAbsName:String = "terms"
fileprivate let constBelowKey:String = "success exactly transit givey OTP"

/*: "#8C7AFF" :*/
fileprivate let k_perMsg:String = "#8C7AFFthin act initial policy exclusive"

/*: "Login" :*/
fileprivate let show_keyValue:String = "trust request themeLogin"

/*: "Send verification" :*/
fileprivate let show_pathKey:String = "enroll bondSend v"
fileprivate let show_foundStr:String = "erobject"
fileprivate let show_othersLogPath:String = "finitecatfiniteon"
...
class CrownedHeadThen: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_coldMessage.map{$0^19}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(app_questFormat) + k_speakData.replacingOccurrences(of: "style", with: "r")).localized : (String(const_masterData) + String(appCurveName.suffix(6)) + noti_duringFreshUrl.replacingOccurrences(of: "composition", with: "ss")).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (userRedMsg.replacingOccurrences(of: "hidden", with: "F4") + userStoryUrl.replacingOccurrences(of: "statistical", with: "4")))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(constFairTitle) + show_denyData.capitalized)
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.locationName(name: (String(mainEasternEffectiveText.prefix(7)) + String(app_harassmentStr) + String(notiThreadUrl)))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (userRedMsg.replacingOccurrences(of: "hidden", with: "F4") + userStoryUrl.replacingOccurrences(of: "statistical", with: "4")))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.bigGallery(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (String(userSupplyValue)))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.locationName(name: (String(notiAssetEyebrowUrl) + String(const_originalStr.prefix(6)) + "elete" + String(k_serveAlreadyPath.suffix(5)))), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(appPhoneInfoFormat)).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (String(mainLeadingMessage)))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (user_engineeringFormat.uppercased()))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(data_smartValue)).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.attractiveIn(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(data_authorityName.suffix(4)) + "n by p" + String(show_visualMessage) + userShowArtName.replacingOccurrences(of: "should", with: "d")).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(dataJumpPhysicsPath.prefix(6)) + dataAbsName.replacingOccurrences(of: "terms", with: "b") + String(constBelowKey.suffix(5))).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(stumble(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(k_perMsg.prefix(7))))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension CrownedHeadThen {
    ...
    @objc private func chinSourceTitle() {
        //: if loginStyleBtn.isSelected == true {
        if loginStyleBtn.isSelected == true { // pwd
    ...
    @objc private func stumble(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(show_keyValue.suffix(5))).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(data_smartValue)).localized, for: .normal)
        }
    ...
    func reserve() {
        ...
        commitButton.setTitle((String(show_pathKey.suffix(6)) + show_foundStr.replacingOccurrences(of: "object", with: "if") + show_othersLogPath.replacingOccurrences(of: "finite", with: "i")).localized, for: .normal)
    }
}
...
extension CrownedHeadThen {
    ...
    private func sumeractionCounteraction() {
        //: commitButton.rx.tap
        commitButton.rx.tap
