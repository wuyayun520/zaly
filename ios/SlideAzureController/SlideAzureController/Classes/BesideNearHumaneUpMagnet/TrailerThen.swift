...
fileprivate let show_tenderKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "bg_vip" :*/
fileprivate let kDistributeFormat:[Character] = ["b","g","_","v","i","p"]
...
class TrailerThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_tenderKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.locationName(name: (String(kDistributeFormat)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.font = UIFont.bigGallery(type: .Medium, fontSize: 15)
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(veryWellFor), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
