...
/*: "#777777" :*/
fileprivate let noti_barRegionData:[Character] = ["#","7","7","7","7","7"]
fileprivate let main_perceiveId:[Character] = ["7"]

/*: "#333333" :*/
fileprivate let mainItsNutMsg:String = "#3333"
fileprivate let kTogetherFormat:String = "home"

/*: "Search" :*/
fileprivate let mainPartyValue:[Character] = ["S","e","a","r","c","h"]

/*: "Details" :*/
fileprivate let const_interestId:[Character] = ["D","e","t","a","i","l","s"]

/*: "nav_back_black_nor" :*/
fileprivate let appQuestUrl:[Character] = ["n"]
fileprivate let main_dropStr:String = "av_bacurrency finger"
fileprivate let user_sumRelatedId:String = "ack_norcompute oval operation press side"
...
// __CLOSE_PRINT__
//
//  GrabSampleViewController.swift
//  AbroadTalking
//
...
class GrabSampleViewController: WeddingLovelyRecognizerDelegate {
    ...
    private lazy var categoryView: JXSegmentedView = {
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (String(noti_barRegionData) + String(main_perceiveId)))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (mainItsNutMsg.capitalized + kTogetherFormat.replacingOccurrences(of: "home", with: "33")))!
        ...
        indicator.indicatorColor = UIColor(hex: (mainItsNutMsg.capitalized + kTogetherFormat.replacingOccurrences(of: "home", with: "33")))!
...
//        view.defaultSelectedIndex = currentIndex
    ...
    private lazy var titleArray: [String] = //: return ["Search".localized, "Details".localized]
        [(String(mainPartyValue)).localized, (String(const_interestId)).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [WeddingLovelyRecognizerDelegate] = //: return [AdvancedFieldDelegate(), TitleureThen()]
        [AdvancedFieldDelegate(), TitleureThen()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.locationName(name: (String(appQuestUrl) + String(main_dropStr.prefix(5)) + "ck_bl" + String(user_sumRelatedId.prefix(7)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(bitAttractiveSpring), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension GrabSampleViewController: JXSegmentedViewDelegate {
...
extension GrabSampleViewController: JXPagingViewDelegate {
...
extension GrabSampleViewController {
    /// 返回按钮事件
    //: @objc private func backButtonClick() {
    @objc private func bitAttractiveSpring() {
