...
fileprivate let show_wallTitle:[UInt8] = [0x80,0x85,0x80,0x8b,0x3f,0x7a,0x86,0x7b,0x7c,0x89,0x51,0x40,0x37,0x7f,0x78,0x8a,0x37,0x85,0x86,0x8b,0x37,0x79,0x7c,0x7c,0x85,0x37,0x80,0x84,0x87,0x83,0x7c,0x84,0x7c,0x85,0x8b,0x7c,0x7b]

fileprivate func scaleStage(upper num: UInt8) -> UInt8 {
...
class NightView: ResidentReactiveCompatible {
    //: var giftData: ResolveCellData?
    var giftData: ResolveCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_wallTitle.map{scaleStage(upper: $0)}, encoding: .utf8)!)
    }
...
extension NightView {
    ...
    override func namePost(with data: AccumulationReactiveCompatible) {
        ...
        //: self.giftData = data as? ResolveCellData
        self.giftData = data as? ResolveCellData
