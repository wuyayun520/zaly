...
fileprivate let main_varietyExceptionMsg:[UInt8] = [0x99,0x9e,0x99,0x84,0xd8,0x93,0x9f,0x94,0x95,0x82,0xca,0xd9,0xd0,0x98,0x91,0x83,0xd0,0x9e,0x9f,0x84,0xd0,0x92,0x95,0x95,0x9e,0xd0,0x99,0x9d,0x80,0x9c,0x95,0x9d,0x95,0x9e,0x84,0x95,0x94]

private func clearTime(calendar num: UInt8) -> UInt8 {
    return num ^ 240
}

/*: "login_logo_icon" :*/
fileprivate let appLackData:[Character] = ["l","o","g","i","n","_","l","o","g","o"]
fileprivate let mainBanFormat:String = "normally observe continuing condition_icon"

/*: "FFFFFF" :*/
fileprivate let main_spendFormat:String = "problem"
fileprivate let user_lopeName:String = "situationsituationsituationsituationsituation"

/*: "128CFF" :*/
fileprivate let noti_fastMessage:String = "sequence exposure lat128CFF"

/*: "Privacy Policy" :*/
fileprivate let kFirstName:String = "translation timingPrivacy "
fileprivate let user_agoText:String = "distinctive corner note outside basicPolicy"

/*: "Terms of Use" :*/
fileprivate let constNeedName:String = "Termsfashion gesture assign domain bright"
fileprivate let kSomebodyFormat:[Character] = [" ","o"]
fileprivate let dataMeetId:String = "f Usefrom premium fee clip wait"

/*: "Contact Us" :*/
fileprivate let const_skinInjuryName:String = "exhibit method weakContac"
fileprivate let constItsWarmName:[Character] = ["t"," ","U","s"]

/*: "By continuing, you agree to our" :*/
fileprivate let const_moreFactName:[UInt8] = [0x70,0xa7,0x4e,0x91,0x9d,0x9c,0xa2,0x97,0x9c,0xa3,0x97,0x9c,0x95,0x5a,0x4e,0xa7,0x9d,0xa3,0x4e,0x8f,0x95,0xa0,0x93,0x93,0x4e,0xa2,0x9d,0x4e,0x9d,0xa3,0xa0]

fileprivate func boxCount(policy num: UInt8) -> UInt8 {
...
fileprivate let user_panSameKey:String = "both firm registerbtn_logi"
fileprivate let userBridgeId:[Character] = ["n","_","g","o","o","g","l","e","_","n","o","r"]

/*: "btn_login_phone_nor" :*/
fileprivate let showTaskThreadTowardKey:[Character] = ["b","t","n","_","l","o","g","i","n","_","p","h","o","n","e","_","n","o","r"]

/*: "btn_login_email_nor" :*/
fileprivate let user_thenValue:String = "btn_lbrow situation"
fileprivate let main_mayKey:String = "observe rate help glass strengthmail_nor"

/*: "btn_login_apple_nor" :*/
fileprivate let mainIdentifyId:[Character] = ["b","t","n","_","l","o","g","i","n","_","a","p","p","l","e","_","n"]
fileprivate let kLatKeyData:[Character] = ["o","r"]

/*: "Continue with Apple" :*/
fileprivate let const_previousWindowTitle:[Character] = ["C","o","n","t","i"]
fileprivate let user_storageFormat:String = "regard operate representative voice videonue w"
fileprivate let constFavoriteKey:String = "icon country boyith Apple"

/*: "login_last_way_icon" :*/
fileprivate let dataEnhanceText:String = "forward partner asklogin_l"
fileprivate let const_thinName:String = "ast_wayround super aid refer"
fileprivate let showArrayStr:[Character] = ["_","i","c","o","n"]

/*: "get json error" :*/
fileprivate let mainPressKey:[Character] = ["g","e","t"," ","j","s"]
fileprivate let user_introPath:[Character] = ["o","n"," ","e","r","r","o","r"]
...
class BlowMainView: UIView {
    //: typealias BtnActionBlock = (_ type: LoginType) -> Void
    typealias BtnActionBlock = (_ type: ContainerCustomReflectable) -> Void
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_varietyExceptionMsg.map{clearTime(calendar: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var logoView: UIImageView = {
        ...
        let imageView = UIImageView(image: UIImage.locationName(name: (String(appLackData) + String(mainBanFormat.suffix(5)))))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    lazy var logoTitleLabel: UILabel = {
        ...
        label.font = .bigGallery(type: .Semibold, fontSize: 28.0)
        //: label.textColor = UIColor(hex: "FFFFFF")
        label.textColor = UIColor(hex: (main_spendFormat.replacingOccurrences(of: "problem", with: "F") + user_lopeName.replacingOccurrences(of: "situation", with: "F")))
        //: label.textAlignment = .center
        label.textAlignment = .center
        //: label.text = AppName
        label.text = showLengthControlUrl
        //: return label
        return label
        //: }()
    }()
    ...
    lazy var privacyBtn: UIButton = {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(noti_fastMessage.suffix(6))))!, .font: UIFont.bigGallery(type: .Regular, fontSize: 14), .underlineStyle: 1] as [NSAttributedString.Key: Any]
        //: let attributeString = NSAttributedString(string: "Privacy Policy".localized, attributes: attributes)
        let attributeString = NSAttributedString(string: (String(kFirstName.suffix(8)) + String(user_agoText.suffix(6))).localized, attributes: attributes)
    ...
    lazy var termsUserBtn: UIButton = {
        ...
        let attributeString = NSAttributedString(string: (String(constNeedName.prefix(5)) + String(kSomebodyFormat) + String(dataMeetId.prefix(5))).localized, attributes: attributes)
        //: btn.setAttributedTitle(attributeString, for: .normal)
        btn.setAttributedTitle(attributeString, for: .normal)
        //: return btn
        return btn
    ...
    lazy var contactBtn: UIButton = {
        ...
        let attributeString = NSAttributedString(string: (String(const_skinInjuryName.suffix(6)) + String(constItsWarmName)).localized, attributes: attributes)
        //: btn.setAttributedTitle(attributeString, for: .normal)
        btn.setAttributedTitle(attributeString, for: .normal)
        //: return btn
        return btn
    ...
    private lazy var agreeLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(noti_fastMessage.suffix(6))))!
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "By continuing, you agree to our".localized
        lab.text = String(bytes: const_moreFactName.map{boxCount(policy: $0)}, encoding: .utf8)!.localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    lazy var googleLoginBtn: UIButton = {
        ...
        btn.setImage(UIImage.locationName(name: (String(user_panSameKey.suffix(8)) + String(userBridgeId))), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_login_google_nor"), for: .highlighted)
        btn.setImage(UIImage.locationName(name: (String(user_panSameKey.suffix(8)) + String(userBridgeId))), for: .highlighted)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var phoneLoginBtn: UIButton = {
        ...
        btn.setImage(UIImage.locationName(name: (String(showTaskThreadTowardKey))), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_login_phone_nor"), for: .highlighted)
        btn.setImage(UIImage.locationName(name: (String(showTaskThreadTowardKey))), for: .highlighted)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var emailLoginBtn: UIButton = {
        ...
        btn.setImage(UIImage.locationName(name: (String(user_thenValue.prefix(5)) + "ogin_e" + String(main_mayKey.suffix(8)))), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_login_email_nor"), for: .highlighted)
        btn.setImage(UIImage.locationName(name: (String(user_thenValue.prefix(5)) + "ogin_e" + String(main_mayKey.suffix(8)))), for: .highlighted)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.font = .bigGallery(type: .Regular, fontSize: 20)
        //: label.textColor =  UIColor(hex: "FFFFFF")
        label.textColor = UIColor(hex: (main_spendFormat.replacingOccurrences(of: "problem", with: "F") + user_lopeName.replacingOccurrences(of: "situation", with: "F")))
        //: label.textAlignment = .center
        label.textAlignment = .center
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (main_spendFormat.replacingOccurrences(of: "problem", with: "F") + user_lopeName.replacingOccurrences(of: "situation", with: "F")))?.withAlphaComponent(0.7)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var appleLoginBtn: RangeReactiveCompatible = {
        ...
        btn.setBackgroundImage(UIImage.satisfyTo(color: UIColor(hex: (main_spendFormat.replacingOccurrences(of: "problem", with: "F") + user_lopeName.replacingOccurrences(of: "situation", with: "F")))!), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_login_apple_nor"), for: .normal)
        btn.setImage(UIImage.locationName(name: (String(mainIdentifyId) + String(kLatKeyData))), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_login_apple_nor"), for: .highlighted)
        btn.setImage(UIImage.locationName(name: (String(mainIdentifyId) + String(kLatKeyData))), for: .highlighted)
        //: btn.setTitle("Continue with Apple".localized, for: .normal)
        btn.setTitle((String(const_previousWindowTitle) + String(user_storageFormat.suffix(5)) + String(constFavoriteKey.suffix(9))).localized, for: .normal)
    ...
    private lazy var lastLoginImgV: RangeReactiveCompatible = {
        //: let btn = TalkingButton()
        let btn = RangeReactiveCompatible()
        //: let ret = UIImage.BundleImageNamed(name: "login_last_way_icon")
        let ret = UIImage.locationName(name: (String(dataEnhanceText.suffix(7)) + String(const_thinName.prefix(7)) + String(showArrayStr)))
...
extension BlowMainView {
    ...
    private func blind() {
        ...
        //: if DismissReactiveCompatible.share.appConfigMode.enableGoogleLogin == true {
        if DismissReactiveCompatible.share.appConfigMode.enableGoogleLogin == true {
        ...
        //: if DismissReactiveCompatible.share.appConfigMode.enableEmailLogin == true {
        if DismissReactiveCompatible.share.appConfigMode.enableEmailLogin == true {
        ...
        //: if DismissReactiveCompatible.share.appConfigMode.enableSmsLogin == true {
        if DismissReactiveCompatible.share.appConfigMode.enableSmsLogin == true {
    ...
    private func per() {
        ...
        logoView.snp.makeConstraints { make in
            ...
            make.top.equalTo(dataPointTitle + actualHeight(h: 80))
        }
        ...
        let lastLogin = data_partyText.string(forKey: userOffdAgentValue)
        ...
        switch ContainerCustomReflectable(rawValue: lastLogin!) {
        //: case .AppleLogin:
        case .AppleLogin:
        ...
        case .EmailLogin, .PwdEmailLogin:
            //: guard DismissReactiveCompatible.share.appConfigMode.enableEmailLogin == true else { return }
            guard DismissReactiveCompatible.share.appConfigMode.enableEmailLogin == true else { return }
            //: lastLoginImgV.snp.makeConstraints { make in
            lastLoginImgV.snp.makeConstraints { make in
        ...
        //: case .GoogleLogin:
        case .GoogleLogin:
            //: guard DismissReactiveCompatible.share.appConfigMode.enableGoogleLogin == true else { return }
            guard DismissReactiveCompatible.share.appConfigMode.enableGoogleLogin == true else { return }
            //: lastLoginImgV.snp.makeConstraints { make in
            lastLoginImgV.snp.makeConstraints { make in
        ...
        case .PhoneLogin, .PwdPhoneLogin:
            //: guard DismissReactiveCompatible.share.appConfigMode.enableSmsLogin == true else {
            guard DismissReactiveCompatible.share.appConfigMode.enableSmsLogin == true else {
                //: return }
                return
            }
    ...
    private func ordinal() {
        ...
        let url = BlackEffectTool.default.recordingRevenue(type: .Login_Main_BG)
        //: do {
        do {
            ...
            printLog(message: (String(mainPressKey) + String(user_introPath)))
        }
        ...
        contactBtn.rx.controlEvent(.touchUpInside)
            //: .subscribe(onNext: {
            .subscribe(onNext: {
                //: PushThen.share.func__pushFeedbackVC()
                PushThen.share.countoBeauty()
                //: })
            })
            //: .disposed(by: disposeBag)
            .disposed(by: disposeBag)
