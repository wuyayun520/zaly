...
fileprivate let app_militaryId:[UInt8] = [0xe7,0xe0,0xe7,0xfa,0xa6,0xed,0xe1,0xea,0xeb,0xfc,0xb4,0xa7,0xae,0xe6,0xef,0xfd,0xae,0xe0,0xe1,0xfa,0xae,0xec,0xeb,0xeb,0xe0,0xae,0xe7,0xe3,0xfe,0xe2,0xeb,0xe3,0xeb,0xe0,0xfa,0xeb,0xea]

/*: "icon_lounge" :*/
fileprivate let app_kingAlongMsg:String = "icosoon"

/*: "#777777" :*/
fileprivate let notiEdgeMessage:[Character] = ["#"]
fileprivate let app_natureKey:String = "livelivelivelivelivelive"

/*: "UID: :*/
fileprivate let user_suitValue:String = "trigger tool hangUID:"
...
// __CLOSE_PRINT__
//
//  TakePlaceReactiveCompatible.swift
//  AbroadTalking
//
...
class TakePlaceReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_militaryId.map{$0^142}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.locationName(name: (app_kingAlongMsg.replacingOccurrences(of: "soon", with: "n") + "_lounge"))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.font = UIFont.bigGallery(type: .Regular, fontSize: 15)
        //: lab.textColor = UIColor(hex: "#777777")
        lab.textColor = UIColor(hex: (String(notiEdgeMessage) + app_natureKey.replacingOccurrences(of: "live", with: "7")))
        //: return lab
        return lab
        //: }()
    }()
...
extension TakePlaceReactiveCompatible {
    /// 刷新
    //: func refreshCell(model: TalkingRecommendUserModel) {
    func coverWant(model: MateHandyJSON) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.bolt(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .thanMortal() : .dialog()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(user_suitValue.suffix(4))) + "\(model.uid)"
