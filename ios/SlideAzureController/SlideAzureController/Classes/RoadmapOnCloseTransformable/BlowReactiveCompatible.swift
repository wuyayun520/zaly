...
fileprivate let user_vitalMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class BlowReactiveCompatible: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [FenceTransformable()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_vitalMsg.reversed(), encoding: .utf8)!)
    }
    ...
    func writePrice(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.ownLight()
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.searched(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.searched(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension BlowReactiveCompatible {
    // 添加视图
