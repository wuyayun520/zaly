...
fileprivate let appLoseContent:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_home_boy" :*/
fileprivate let userAwakeFormat:String = "temporary style lopeicon_h"

/*: "icon_home_girl" :*/
fileprivate let main_customerStr:[Character] = ["i","c","o","n","_","h","o","m","e"]
fileprivate let k_disabledValue:[Character] = ["_","g","i","r","l"]
...
class OnLineView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appLoseContent.reversed(), encoding: .utf8)!)
    }
...
extension OnLineView {
    ...
    func sinceLimited(model: SparkTransformable, type: SpillCollection) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.locationName(name: (String(userAwakeFormat.suffix(6)) + "ome_boy")), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.locationName(name: (String(main_customerStr) + String(k_disabledValue))), for: .normal)
        //: break
        //: default:
        default:
            //: break
