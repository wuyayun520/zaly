...
fileprivate let main_unlessRecoverTitle:[UInt8] = [0xc2,0xc5,0xc2,0xdf,0x83,0xc8,0xc4,0xcf,0xce,0xd9,0x91,0x82,0x8b,0xc3,0xca,0xd8,0x8b,0xc5,0xc4,0xdf,0x8b,0xc9,0xce,0xce,0xc5,0x8b,0xc2,0xc6,0xdb,0xc7,0xce,0xc6,0xce,0xc5,0xdf,0xce,0xcf]

private func perceiveTurnShape(trust num: UInt8) -> UInt8 {
    return num ^ 171
}

/*: "F5F5F5" :*/
fileprivate let user_singleId:String = "capcapcap"
...
class TillReactiveCompatible: UITableViewCell {
    ...
    var videoView = TransferVideoCell()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_unlessRecoverTitle.map{perceiveTurnShape(trust: $0)}, encoding: .utf8)!)
    }
    ...
    func playerCell(isListTableCell: Bool) {
    ...
    lazy var userInfoView: RailroadingReactiveCompatible = {
        //: let  view = TalkingMomentUserInfoView.init()
        let view = RailroadingReactiveCompatible()
    ...
    lazy var textContentView: RegularAssemblageReactiveCompatible = {
        //: let  view = TalkingMomentTextContentView.init()
        let view = RegularAssemblageReactiveCompatible()
        //: backView.addSubview(view)
        backView.addSubview(view)
        //: return view
        return view
    ...
    lazy var photoView: WritingView = {
        ...
        let view = WritingView(frame: CGRect(x: 0, y: 0, width: 0, height: 0), collectionViewLayout: flayout)
        //: backView.addSubview(view)
        backView.addSubview(view)
        //: return view
        return view
    ...
    lazy var bottomView: PartBottomView = {
        //: let  view = TalkingMomentItemBottomView.init()
        let view = PartBottomView()
        //: backView.addSubview(view)
        backView.addSubview(view)
        //: return view
        return view
    ...
    lazy var lineView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (user_singleId.replacingOccurrences(of: "cap", with: "F5")))
        //: self.contentView.addSubview(view)
        self.contentView.addSubview(view)
        //: return view
        return view
...
//            }
            ...
            photoView.gravityAwake(model: cunrrenModel)
...
//            }
            ...
            videoView.errorNextTop(model: model.videoInfo!, isTop: model.pinStatus)
        }

        //: bottomView.configModel(model: cunrrenModel)
        bottomView.springtime(model: cunrrenModel)
...
//        }
    ...
    @objc func refresh() {
        ...
        let vc = NightRecognizerDelegate(videoPath: cunrrenModel.videoInfo!.videoUrl)
        //: if cunrrenModel.sex != DismissReactiveCompatible.share.loginUserMode.sex {
        if cunrrenModel.sex != DismissReactiveCompatible.share.loginUserMode.sex {
    ...
    func anMark() {
        ...
        if cunrrenModel.momentType == HiddenMomentType.Video.rawValue {
    ...
    //: func stopPlay() {
    func purchaseBecomePress() {
        //: if videoView.isPlaying {
        if videoView.isPlaying {
            //: videoView.stopPlay()
            videoView.stallAnima()
        }
    }
