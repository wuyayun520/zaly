...
fileprivate let userStackMsg:[UInt8] = [0x4c,0x4b,0x4c,0x51,0xd,0x46,0x4a,0x41,0x40,0x57,0x1f,0xc,0x5,0x4d,0x44,0x56,0x5,0x4b,0x4a,0x51,0x5,0x47,0x40,0x40,0x4b,0x5,0x4c,0x48,0x55,0x49,0x40,0x48,0x40,0x4b,0x51,0x40,0x41]

/*: "Cancel" :*/
fileprivate let noti_prettyStr:String = "Cancelits list snap"

/*: "Sure" :*/
fileprivate let dataGrayKey:[Character] = ["S","u","r","e"]
...
class NameurePickView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userStackMsg.map{$0^37}, encoding: .utf8)!)
    }

    //: private func setupView() {
    private func recordJaw() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(buttonObject))
        ...
        cancelButton.setTitle((String(noti_prettyStr.prefix(6))).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(evaluation(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(dataGrayKey)).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(replySpring(button:)), for: .touchUpInside)
    ...
    // 子类重写
    //: func initPickView() {
    func beardApplication() {}

    //: private func undateView() {
    private func decideEnable() {
    ...
    @objc func evaluation(button _: UIButton) {
        //: dismissView()
        buttonObject()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func replySpring(button _: UIButton) {
        //: dismissView()
        buttonObject()
    }
