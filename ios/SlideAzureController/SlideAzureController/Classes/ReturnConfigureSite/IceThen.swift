...
/*: "detection" :*/
fileprivate let const_enableMessage:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let data_whoHeEquallyUrl:String = "huntingff"
...
class IceThen: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = IceThen()
    ...
    func taproot() {
        ...
        let soundFilePath = BlackEffectTool.default.undersized(name: (String(const_enableMessage)), type: (data_whoHeEquallyUrl.replacingOccurrences(of: "hunting", with: "ai")))
