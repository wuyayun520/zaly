...
fileprivate let user_refNearbyPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
enum RunningAbsoluteSwipeDirection: CaseIterable {
    //: case Left
    case Left
    //: case Right
    case Right
...
protocol CeremonialOccasionObjectProtocol: NSObjectProtocol {
    ///
...
class ManufacturerView: UIView {
    ...
    var cell_delegate: CeremonialOccasionObjectProtocol?

    //: var model: TalkingMatchResultModel?
    var model: ConcentrationScientificTheoryMeasurable?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_refNearbyPath.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(conversionMotion(pan:)))
        //: v.delegate = self
        v.delegate = self
        //: return v
        return v
...
extension ManufacturerView: UIGestureRecognizerDelegate {
    ...
    @objc func conversionMotion(pan: UIPanGestureRecognizer) {
        //: switch pan.state {
        switch pan.state {
        //: case .began:
        case .began:
        ...
        case .changed:
            ...
            if RatingReactiveCompatible.shared.direction == .rightToLeft {
                ...
                if movePoint.x > main_logStr / 4 {
                    ...
                    self.cell_delegate?.tokenishBarrier(cell: self, forMovePoint: self.currentPoint)
    ...
    func bundle(direction: RunningAbsoluteSwipeDirection) {
        //: switch (direction) {
        switch direction {
        //: case .Left:
        case .Left:
