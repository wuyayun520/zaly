...
fileprivate let kReaderRunnerFormat:[Character] = ["A","r","e","a","C","o","d","e","C","h","o","i","c","e","C","e","l"]
fileprivate let showMakeupTitle:String = "production boy filelID"

/*: "init(coder:) has not been implemented" :*/
fileprivate let k_plyFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Select Country Code" :*/
fileprivate let k_tailName:[Character] = ["S","e","l","e","c","t"," ","C","o","u","n","t","r","y"," ","C","o","d"]
fileprivate let noti_combineGreenText:[Character] = ["e"]

/*: "#F4F6FA" :*/
fileprivate let notiReasonPath:[Character] = ["#","F","4","F","6","F","A"]
...
class SmallRecognizerDelegate: WeddingLovelyRecognizerDelegate {
    //: public var backCountryCode: ((TalkingAreaModel) -> Void)?
    public var backCountryCode: ((ImpressionAreaModel) -> Void)?

    //: private let TalkingAreaCodeChoiceCellID = "AreaCodeChoiceCellID"
    private let TalkingAreaCodeChoiceCellID = (String(kReaderRunnerFormat) + String(showMakeupTitle.suffix(3)))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_plyFormat.reversed(), encoding: .utf8)!)
    }
    ...
    override func viewDidLoad() {
        ...
        self.title = (String(k_tailName) + String(noti_combineGreenText)).localized
        ...
        self.numbereractionBindContainer()
    }
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(RunningReactiveCompatible.classForCoder(), forCellReuseIdentifier: TalkingAreaCodeChoiceCellID)
        ...
        tableView.backgroundColor = UIColor(hex: (String(notiReasonPath)))
        //: return tableView
        return tableView
        //: }()
    }()
...
extension SmallRecognizerDelegate {
...
extension SmallRecognizerDelegate: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: RunningReactiveCompatible = tableView.dequeueReusableCell(withIdentifier: TalkingAreaCodeChoiceCellID, for: indexPath) as! RunningReactiveCompatible
        ...
        cell.includeIncrease(areaModel: array[indexPath.row])
...
extension SmallRecognizerDelegate {
    ...
    private func numbereractionBindContainer() {}
}
